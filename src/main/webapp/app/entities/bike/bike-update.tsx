  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hipSagesApp.bike.home.createOrEditLabel" data-cy="BikeCreateUpdateHeading">
            <Translate contentKey="hipSagesApp.bike.home.createOrEditLabel">Create or edit a Bike</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('hipSagesApp.bike.model')} id="bike-model" name="model" data-cy="model" type="text" />
              <ValidatedField
                label={translate('hipSagesApp.bike.serialNo')}
                id="bike-serialNo"
                name="serialNo"
                data-cy="serialNo"
                type="text"
              />
              <ValidatedField id="bike-owner" name="owner" data-cy="owner" label={translate('hipSagesApp.bike.owner')} type="select">
                <option value="" key="0" />
                {owners

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hipSagesApp.driver.home.createOrEditLabel" data-cy="DriverCreateUpdateHeading">
            <Translate contentKey="hipSagesApp.driver.home.createOrEditLabel">Create or edit a Driver</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('hipSagesApp.driver.name')} id="driver-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('hipSagesApp.driver.lastName')}
                id="driver-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField
                label={translate('hipSagesApp.driver.mileage')}
                id="driver-mileage"
                name="mileage"
                data-cy="mileage"
                type="text"

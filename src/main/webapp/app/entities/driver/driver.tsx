  ...
  return (
    <div>
      <h2 id="driver-heading" data-cy="DriverHeading">
        <Translate contentKey="hipSagesApp.driver.home.title">Drivers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hipSagesApp.driver.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/driver/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hipSagesApp.driver.home.createLabel">Create new Driver</Translate>
          </Link>
        </div>
      </h2>
        ...
        {driverList && driverList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hipSagesApp.driver.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.driver.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.driver.lastName">Last Name</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.driver.mileage">Mileage</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hipSagesApp.driver.home.notFound">No Drivers found</Translate>
            </div>
          )
        )}
      </div>

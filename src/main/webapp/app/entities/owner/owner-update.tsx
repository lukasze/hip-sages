  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hipSagesApp.owner.home.createOrEditLabel" data-cy="OwnerCreateUpdateHeading">
            <Translate contentKey="hipSagesApp.owner.home.createOrEditLabel">Create or edit a Owner</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('hipSagesApp.owner.name')} id="owner-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('hipSagesApp.owner.lastName')}
                id="owner-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField
                label={translate('hipSagesApp.owner.mileage')}
                id="owner-mileage"
                name="mileage"
                data-cy="mileage"
                type="text"

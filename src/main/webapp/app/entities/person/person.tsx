  ...
  return (
    <div>
      <h2 id="person-heading" data-cy="PersonHeading">
        <Translate contentKey="hipSagesApp.person.home.title">People</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hipSagesApp.person.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/person/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hipSagesApp.person.home.createLabel">Create new Person</Translate>
          </Link>
        </div>
      </h2>
        ...
        {personList && personList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hipSagesApp.person.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.person.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.person.lastName">Last Name</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.person.glasses">Glasses</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hipSagesApp.person.home.notFound">No People found</Translate>
            </div>
          )
        )}
      </div>

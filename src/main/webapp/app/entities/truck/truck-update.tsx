  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hipSagesApp.truck.home.createOrEditLabel" data-cy="TruckCreateUpdateHeading">
            <Translate contentKey="hipSagesApp.truck.home.createOrEditLabel">Create or edit a Truck</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('hipSagesApp.truck.model')} id="truck-model" name="model" data-cy="model" type="text" />
              <ValidatedField label={translate('hipSagesApp.truck.engine')} id="truck-engine" name="engine" data-cy="engine" type="text" />
              <ValidatedField
                label={translate('hipSagesApp.truck.serialNo')}
                id="truck-serialNo"
                name="serialNo"
                data-cy="serialNo"
                type="text"
              />
              <ValidatedField
                label={translate('hipSagesApp.truck.driver')}
                id="truck-driver"
                data-cy="driver"
                type="select"
                multiple

  ...
  return (
    <div>
      <h2 id="truck-heading" data-cy="TruckHeading">
        <Translate contentKey="hipSagesApp.truck.home.title">Trucks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hipSagesApp.truck.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/truck/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hipSagesApp.truck.home.createLabel">Create new Truck</Translate>
          </Link>
        </div>
      </h2>
        ...
        {truckList && truckList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hipSagesApp.truck.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.truck.model">Model</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.truck.engine">Engine</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.truck.serialNo">Serial No</Translate>
                </th>
                <th>
                  <Translate contentKey="hipSagesApp.truck.driver">Driver</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hipSagesApp.truck.home.notFound">No Trucks found</Translate>
            </div>
          )
        )}
      </div>
